...
//     console.log('product_today_count테이블에 증가데이터 입력시작.');
//     let cart = 0;
//     let wish = 0;
//     let access = 0;
//     for (let product of products) {
...
//         }
//     }
//     console.log('product_today_count테이블에 증가데이터 입력종료.');

//     // 어제 데이터 삭제 (전체 데이터 삭제)
//     console.log('temporary_product_count테이블의 어제 데이터 삭제시작.');
//     try {
...
//         }
//     console.log('temporary_product_count테이블의 어제 데이터 삭제종료.');
//     // 오늘 데이터 등록
//     console.log('temporary_product_count테이블에 오늘 데이터 등록시작.');
//     for (let product of products) {
//         if (product.productId) {
//             try {
//                 await TemporaryProduct.create({
...
//         }
//     }
//     console.log('temporary_product_count테이블에 오늘 데이터 등록종료.');
